...
<form action="${pageContext.request.contextPath}/OptionSelectServlet"
    ...
    <div class="section-box">
        <div class="option-area">
            ...
            <input type="checkbox" name="option1" value="水回り"> 水回りのトラブル 2000円
        </label>

        <label class="option-box">
            <input type="checkbox" name="option2" value="鍵の交換・修理"> 鍵の交換・修理 3000円
        </label>

        <label class="option-box">
            <input type="checkbox" name="option3" value="エアコン修理・クリーニング"> エアコン修理・クリーニング 4000円
        </label>
