    ...
    <div class="section-box">
        <div class="option-area">
            ...
            <label class="option-box">
	            <input type="checkbox" name="option1" value="しみ抜き"> しみ抜き 3000円
	        </label>
	
	        <label class="option-box">
	            <input type="checkbox" name="option2" value="においブロック加工"> においブロック加工 2000円
	        </label>
	
	        <label class="option-box">
	            <input type="checkbox" name="option3" value="撥水加工"> はっ水加工 3000円
	        </label>
